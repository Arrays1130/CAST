...
<body class="landing-3d font-sans text-ink">
    ...
    <header class="landing-nav fixed inset-x-0 top-0 z-30">
        <div class="landing-nav-shell">
            <a href="{{ url('/') }}" class="flex items-center gap-3 text-sm font-semibold text-ink">
                <span class="cast-mark landing-brand-mark">C</span>
                <span>
                    <span class="block font-display leading-none tracking-tight">CAST</span>
                    <span class="mt-1 block text-[9px] font-medium uppercase tracking-[0.22em] text-notion-faint">Assessment studio</span>
                </span>
            </a>
            <nav class="hidden items-center gap-5 text-[10px] font-semibold uppercase tracking-[0.18em] text-notion-muted md:flex" aria-label="Landing sections">
                <a href="#scene-0" class="hover:text-ink">Studio</a>
                <a href="#scene-1" class="hover:text-ink">Submit</a>
                <a href="#scene-2" class="hover:text-ink">Review</a>
                <a href="#scene-4" class="hover:text-ink">Ship</a>
            </nav>
